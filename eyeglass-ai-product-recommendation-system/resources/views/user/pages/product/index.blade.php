...
@section("content")
            ...
            <div class="flex-w flex-sb-m p-b-52">
                <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                    ...
                    @foreach($typeProducts as $item)
                        <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".type{{$item->id}}">
                            {{$item->name}}
                        </button>
                    @endforeach
                ...
                <!-- Search product -->
                    ...
                    <div class="dis-none panel-search w-full p-t-10 p-b-15">
                            <form action="" method="get" class="bor8 dis-flex p-l-15">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item type{{$item->typeProduct->id}}">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                ...
                                <a href="{{route('user.product.detail', ["id"=>$item->id])}}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
                                    Xem chi tiết
                                </a>
                            </div> 
    ...
    <!-- Modal1 -->
    <div class="wrap-modal1 js-modal1 p-t-60 p-b-20" id="galleryModal">
        <div class="overlay-modal1 js-hide-modal1"></div>

        <div class="container" >
            <div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
                <button class="how-pos3 hov3 trans-04 js-hide-modal1">
                    <img src="{{asset('asset/user/images/icons/icon-close.png')}}" alt="CLOSE">
                </button>
                                ...
                                <div class="slick3 gallery-lb">
                                    <div class="item-slick3" data-thumb="asset/user/images/product-detail-02.jpg">
                                        <div class="wrap-pic-w pos-relative">
                                            <img src="{{url('asset/user/images/product-detail-02.jpg')}}" id="galleryImage" alt="IMG-PRODUCT">
