...
// ini_set('memory_limit', '256'); // Tăng giới hạn lên 1GB
...
Route::prefix('/')->group(function(){
    ...
    Route::prefix('/message')->group(function(){
        Route::get('/', [MessageController::class, 'index'])->name('user.message.index');
        Route::post('/create', [MessageController::class, 'solveCreate'])->name('user.message.solveCreate');
        Route::get('/create/{content}/{type}/{id}/{product_id}', [MessageController::class, 'create'])->name('user.message.create');
    });
